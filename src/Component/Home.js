    ...
    return(
        <div style={{height: '100%',display: 'flex',width: '100%'}}>
            ...
            <div style={{fontWeight: '600',fontSize: 'large',flexBasis: '85%',padding: '4% 0 4% 4%',textAlign: 'center',alignSelf:'center'}}>
                <DynamicTyping text="Hi, I'm Suchita" speed={60} /><br />
                <DynamicTyping text="Passionate Frontend Developer specializing in React & JavaScript" speed={60}  /><br/>
                <DynamicTyping text="Focused on building interactive, user-friendly, and performant web apps" speed={50}  /><br/>
            </div>
        </div>
    )
}
